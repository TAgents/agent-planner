...
/**
 * Get all activities for a node (logs, comments, status changes) — aggregated view
 * Consolidated from activities.controller.js
 */
const getNodeActivities = async (req, res) => {
  try {
    const { id: planId, nodeId } = req.params;
